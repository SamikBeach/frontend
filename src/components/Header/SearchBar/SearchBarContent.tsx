      ...
      <section>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex cursor-pointer gap-3 rounded-lg p-2 transition-colors hover:bg-gray-50">
            ...
            />
            <div>
              <h3 className="font-medium text-gray-900">짜라투스트라는 이렇게 말했다</h3>
              <p className="mt-0.5 text-sm text-gray-500">프리드리히 니체 · 민음사 · 2021</p>
              <div className="mt-1.5 flex gap-2 text-sm text-gray-600">
                <span className="flex items-center gap-1">
                  <ThumbsUpIcon className="h-3.5 w-3.5" />300
                </span>
                <span className="flex items-center gap-1">
                  <MessageSquareIcon className="h-3.5 w-3.5" />212
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex cursor-pointer gap-3 rounded-lg p-2 transition-colors hover:bg-gray-50">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-500">Friedrich Wilhelm Nietzsche</p>
              <div className="mt-1.5 flex gap-2 text-sm text-gray-600">
                <span className="flex items-center gap-1">
                  <BookIcon className="h-3.5 w-3.5" />12
                </span>
                <span className="flex items-center gap-1">
                  <ThumbsUpIcon className="h-3.5 w-3.5" />300
                </span>
